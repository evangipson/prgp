...
namespace PRPG.Platform.Constants
{
	public static class LanguageConstants
	{
		...
		public static readonly Dictionary<Language, IEnumerable<string>> LanguageKeywords = new()
		{
			[Language.FluidScript] = ["func", "ret", "var"],
			[Language.TypeR] = ["class", "create", "int"],
			[Language.N] = ["<-"],
			[Language.LambdaFlow] = ["def", "obj", "Int"]
		};
